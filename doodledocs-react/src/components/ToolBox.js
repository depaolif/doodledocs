	...
	render() {
		...
		return (
			<div className="toolbox">
				...
				{selector}
				<img name="free" src="http://res.cloudinary.com/dletp3dah/image/upload/c_scale,w_32/v1493059354/ic_edit_black_24dp_1x_ashvkr.png" alt="free" className="icon" onClick={this.handleClick} />

				<button name="line" onClick={this.handleClick}>Line</button>
				<button name="circle" onClick={this.handleClick}>Circle</button>
				<img name="rectangle" src="http://res.cloudinary.com/dletp3dah/image/upload/c_scale,w_32/v1493058803/ic_crop_din_black_24dp_1x_tmmokd.png" alt="square" className="icon" onClick={this.handleClick} />
